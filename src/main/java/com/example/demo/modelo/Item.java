...
@NamedNativeQuery(name = "Item.validarExistencia", query = "select * from item where item_codigo_barras=:datoCodigo")
...
public class Item {
	...
	private Integer stock; // catidad de existencia del producto
